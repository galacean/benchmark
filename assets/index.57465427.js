import{g as f,h as T,i as nn,j as A,V as m,k as $,K as C,l as R,m as L,C as k,S as Y,n as ee,o as ne,R as Ve,T as Be,p as rn,q as tn,L as an,r as on,s as J,t as ln,u as He,M as V,Q as N,v as ve,D as fe,w as ge,x as pe,y as xe,z as ie,E as Oe,G as Ge,F as je,B as sn,H as un,I as _n,J as cn,N as z,O as dn,U as mn,X as hn,Y as ye,c as vn,Z as fn,_ as Ke}from"./module.181431e5.js";function Ce(a,n){for(var s=0;s<n.length;s++){var r=n[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(a,r.key,r)}}function gn(a,n,s){return n&&Ce(a.prototype,n),s&&Ce(a,s),a}function oe(a,n){return oe=Object.setPrototypeOf||function(r,e){return r.__proto__=e,r},oe(a,n)}function pn(a,n){if(typeof n!="function"&&n!==null)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(n&&n.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),n&&oe(a,n)}f.getByName("u_width");f.getByName("u_min");f.getByName("u_max");f.getByName("u_boxColor");f.getByName("u_borderColor");T.create("box",`
#include <common>
#include <common_vert>
